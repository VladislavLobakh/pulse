workspace "PULSE" "AI Intelligence & Content Factory — C4 structural model (L1 Context + L2 Container)" {
    ...
    model {
        ...
        youtube      = softwareSystem "YouTube"           "Video transcripts source."                       "External,Implemented"
        newsletters  = softwareSystem "RSS Newsletters"   "Latent Space, Simon Willison, etc."              "External,Implemented"
        ...
        pulse.agentRuntime -> youtube      "Fetches transcripts from"         "HTTPS"           "Implemented"
