---
name: code-review
description: Read-only code review for git diffs — correctness, PULSE architecture, conventions, tests, docs. Use when asked to review, audit, or check a PR/branch before merge.
...
- `/code-review`, "review this PR/branch", audit or feedback on a diff
- Staged or uncommitted changes ready for a quality pass
- Risky changes: contracts, security, shared modules, architecture files
